...
-- 
-- @version $Id: 013_Scheduling.sql,v 1.2 2007/09/13 16:04:16 adamfranco Exp $
-- */
-- --------------------------------------------------------
-- 
...
CREATE INDEX sc_item_index ON sc_item (start_date,end_date,fk_sc_item_stat_type,master_id);

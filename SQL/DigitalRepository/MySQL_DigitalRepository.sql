...
CREATE TABLE dr_asset_record (
  FK_asset int(10) unsigned NOT NULL default '0',
  FK_record int(10) unsigned NOT NULL default '0',
  structure_id varchar(255) NOT NULL default '',
  PRIMARY KEY  (FK_asset,FK_record,structure_id)
) TYPE=MyISAM;
...
CREATE TABLE dr_file_data (
  FK_file int(10) unsigned NOT NULL default '0',
...
CREATE TABLE dr_type (
  ...
  PRIMARY KEY  (type_id),
  UNIQUE KEY type (type_domain,type_authority,type_keyword)
) TYPE=MyISAM;

...
/**
 * AssessmentTakenIterator provides access to these objects sequentially, one
 ...
 */
interface AssessmentTakenIterator
{
    /**
     * Return true if there is an additional  AssessmentTaken ; false
     * otherwise.
     *  
     * @return boolean
     * 
     ...
     * @access public
     */
    public function hasNextAssessmentTaken (); 
     ...
     * @access public
     */
    public function nextAssessmentTaken (); 
}

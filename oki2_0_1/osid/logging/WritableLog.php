...
interface WritableLog
{
     ...
     * @access public
     */
    public function appendLog ( $entryItem ); 
     ...
     * @access public
     */
    public function appendLogWithTypes ( $entryItem, Type $formatType, Type $priorityType ); 
     ...
     * @access public
     */
    public function assignPriorityType ( Type $priorityType ); 
     ...
     * @access public
     */
    public function assignFormatType ( Type $formatType ); 
}

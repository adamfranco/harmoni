    ...
    extends SharedException
{
     ...
     * @static 
     */
    const  UNKNOWN_NAME = "Unknown log name ";
     ...
     * @static 
     */
    const  DUPLICATE_NAME = "Duplicate log name ";
     ...
     * @static 
     */
    const  PRIORITY_TYPE_NOT_SET = "PriorityType not set ";
     ...
     * @static 
     */
    const  FORMAT_TYPE_NOT_SET = "FormatType not set ";
}

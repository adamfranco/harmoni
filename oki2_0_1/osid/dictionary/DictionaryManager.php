    ...
    extends OsidManager
{
     ...
     * @access public
     */
    public function createDictionary ( $displayName, $description, $domain ); 
     ...
     * @access public
     */
    public function deleteDictionary ( Id $dictionaryId ); 
     ...
     * @access public
     */
    public function getDictionary ( Id $dictionaryId ); 

    ...
    extends OsidManager
{
     ...
     * @access public
     */
    public function createHierarchy ( $displayName, array $nodeTypes, $description, $allowsMultipleParents, $allowsRecursion ); 
     ...
     * @access public
     */
    public function getHierarchy ( Id $hierarchyId ); 
     ...
     * @access public
     */
    public function deleteHierarchy ( Id $hierarchyId ); 

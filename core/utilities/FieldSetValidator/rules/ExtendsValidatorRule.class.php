 ...
 *
 * @version $Id: ExtendsValidatorRule.class.php,v 1.6 2007/10/09 21:12:00 adamfranco Exp $
 */ 
	...
	extends ValidatorRuleInterface 
{
	 ...
	 **/
	function check( $val ) {
		return ($val instanceof $this->_parentClassName);
	}
	 ...
	 * @since 3/28/05
	 */
	static function getRule ($parentClassName) {

 ...
 * @version $Id: IDManager.class.php,v 1.9 2004/01/22 21:06:58 adamfranco Exp $
 * @author Gabe Schine
 * @copyright 2004
 * @access public
 **/
...
class IDManager
	...
	function setup( $dbID ) {
		...
		// Make sure the IdManager is started
		if (!Services::serviceRunning("IDManager")) {
			Services::startService("IDManager", $dbID);
		}
	}

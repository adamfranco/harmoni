 ...
 * @version $Id: DataSetTypeManager.class.php,v 1.31 2005/01/03 20:50:32 adamfranco Exp $
 * @author Gabe Schine
 * @copyright 2004
 * @access public
 **/
...
//			printpre($rows);
	...
	*/
	...
	function &_addDataSetType(&$type, $revision) {
		...
		debug::output("Created new DataSetType object for '".OKITypeToString($type)."', revision $revision; with Id, '".$newID->getIdString()."'.",DEBUG_SYS5,"DataSetTypeManager");

<?
	 ...
	 */
class FileDataInfoPart extends InfoPart
//	extends java.io.Serializable
{

	var $_infoStructure;
	
	function FileDataInfoPart(&$infoStructure) {
	...
	function getDescription() {
		return "The binary data-stream for the file.";
	}
	...
	function &getType() {
		if (!isset($this->_type)) {
			$this->_type =& new HarmoniType("DR", "Harmoni", "blob");
		}
	...
	function &getId() {
		...
		return $sharedManager->getId("FILE_DATA");
	}

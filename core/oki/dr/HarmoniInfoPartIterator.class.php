...
/**
  ...
  *
  * @version $Id: HarmoniInfoPartIterator.class.php,v 1.6 2005/03/29 19:44:17 adamfranco Exp $
  */
...
{ // begin InfoPartIterator
	...
	function HarmoniInfoPartIterator (& $infoPartArray) {
		...
		ArgumentValidator::validate($infoPartArray, ArrayValidatorRuleWithRule::getRule(ExtendsValidatorRule::getRule("InfoPart")));

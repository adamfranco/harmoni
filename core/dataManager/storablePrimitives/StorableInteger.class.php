 ...
 *
 * @version $Id: StorableInteger.class.php,v 1.9 2005/07/13 19:59:42 adamfranco Exp $
 */
 ...
 *********************************************************/
  ...
  *********************************************************/
	...
	function insert($dbID) {
		...
		$query->addRowOfValues(array("'".addslashes($newID->getIdString())."'", $this->getIntegerValue()));

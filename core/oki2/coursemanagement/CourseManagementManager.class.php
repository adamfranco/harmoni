...
*
* @version $Id: CourseManagementManager.class.php,v 1.52 2008/02/06 15:37:48 adamfranco Exp $
*/
	...
	implements CourseManagementManager
{
				...
				*********************************************************/
				...
				if(!$res->hasMoreRows()){
					...
					foreach($terms as $array){
						...
						$schedule[0] =$sm->v3_createScheduleItem($name." range","The start and end of the ".$name." Term",
						$type,$start,$end,null);
	...
	* @access public
	*/
	function deleteCanonicalCourse ( Id $canonicalCourseId ) {
	...
	* @access public
	*/
	function getCanonicalCourse ( Id $canonicalCourseId ) {
		$node =$this->_hierarchy->getNode($canonicalCourseId);
	...
	* @access public
	*/
	function getCourseOffering ( Id $courseOfferingId ) {
	...
	* @access public
	*/
	function getCourseSection ( Id $courseSectionId ) {
	...
	* @access public
	*/
	function getCourseSections ( Id $agentId ) {
	...
	* @access public
	*/
	function getCourseOfferings ( Id $agentId ) {
	...
	* @access public
	*/
	function createTerm ( Type $termType, array $schedule, $displayname = "" ) {
	...
	* @access public
	*/
	function getCourseGradeRecords ( Id $agentId, Id $courseOfferingId, Type $courseGradeType ) {
	...
	* @access public
	*/
	function createCourseGroup ( Type $courseGroupType ) {
		$idManager = Services::getService("IdManager");
		$id=$idManager->createId();
	...
	* @access public
	*/
	function deleteCourseGroup ( Id $courseGroupId ) {
	...
	* @access public
	*/
	function getCourseGroup ( Id $courseGroupId ) {
		$node =$this->_hierarchy->getNode($courseGroupId);
		$ret = new HarmoniCourseGroup($node);
		return $ret;
	...
	* @access public
	*/
	function getCourseGroupsByType ( Type $courseGroupType ) {
	...
	* @access public
	*/
	function getCourseGroups ( Id $canonicalCourseId ) {

<?php
    ...
    class TermTest extends OKIUnitTestCase {
        ...
        function TestOfTerm() {
			...
			$scheduleItemA1 =$sm->v3_createScheduleItem("Fall 2006 range", "", $scheduleItemType, 300, 900, null);
			...
			$scheduleItemB1 =$sm->v3_createScheduleItem("Fall 2006 range", "", $scheduleItemType, 1300, 1900, null);
			$scheduleItemB2 =$sm->v3_createScheduleItem("Thanksgiving", "", $scheduleItemType, 1350, 1400, null);
			$scheduleItemB3 =$sm->v3_createScheduleItem("Christmas", "ho ho ho", $scheduleItemType, 1500, 1600, null);				
			
			$scheduleItemC1 =$sm->v3_createScheduleItem("Funky time", "", $scheduleItemType, 100, 500, null);
			$scheduleItemC2 =$sm->v3_createScheduleItem("Dance party", "", $scheduleItemType, 700, 1400, null);

...
require_once(OKI2."/osid/coursemanagement/TermIterator.php");
 ...
 *
 * @version $Id: TermIterator.class.php,v 1.3 2005/01/19 17:39:09 adamfranco Exp $
 */
class HarmoniTermIterator
	extends HarmoniIterator
//	implements TermIterator
{
	/**

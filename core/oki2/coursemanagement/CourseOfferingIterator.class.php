...
require_once(OKI2."/osid/coursemanagement/CourseOfferingIterator.php");
 ...
 *
 * @version $Id: CourseOfferingIterator.class.php,v 1.4 2005/01/19 22:28:21 adamfranco Exp $
 */
class HarmoniCourseOfferingIterator
	extends HarmoniIterator
//	implements CourseOfferingIterator
{
	/**
	 ...
	 * @access public
	 */
	function hasNextCourseOffering () { 
		return $this->hasNext();
	} 

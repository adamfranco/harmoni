<?
	 ...
	 */
class ThumbnailDataInfoField extends InfoField
//	extends java.io.Serializable
{
	...
	function ThumbnailDataInfoField( &$infoPart, &$recordId, $configuration ) {
	...
	function &getId() {
		...
		return $sharedManager->getId($this->_recordId->getIdString()."-THUMBNAIL_DATA");
	}

...
extends GUIManagerAbstract
{
	...
	*/
	...
	/**
	* A list of default themes anyone can access.  The array should 
	* contain several arrays with two parameters.  The first is a display name.
	* The second is the name of the Theme's class 
	* 
	* @var array _themeList 
	* @access protected
	*/
	var $_themeList;
	...
	**/
	function getStyleCollectionPath() {
	...
	*/
	function saveTheme () {
		...
		'theme_description', 'theme_template', 'theme_custom_lev','theme_owner_id'));
	...
	*/
	function getThemeListForUser () {
		$returnArray = array();
		foreach ($this->_themeList as $theme){			

 ...
 *
 * @version $Id: BorderRightSP.class.php,v 1.5 2006/06/02 15:56:07 cws-midd Exp $
 */
class BorderRightSP extends StyleProperty {
	...
	function __construct($width, $style, $color) {
		parent::__construct("border-right", "Right Border", "This property specifies the right border.");

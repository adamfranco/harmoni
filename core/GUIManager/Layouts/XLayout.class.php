 ...
 * @version $Id: XLayout.class.php,v 1.1 2004/07/19 23:59:51 dobomode Exp $
...
class XLayout extends LayoutInterface {
	...
	function XLayout() {
		...
		$coll =& new StyleCollection("harmoni-x-layout");
	...
	function render($container, $tabs = "") {
		...
		foreach (array_keys($components) as $key) {
			...
			echo $tabs."\t<td class=\"harmoni-x-layout\"$width$height$halign$valign>\n";

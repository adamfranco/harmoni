...
require_once(HARMONI."authenticationHandler/methods/DummyAuthenticationMethod.class.php");
 ...
 * 
 * @version $Id: AuthenticationHandler.class.php,v 1.15 2003/07/25 00:53:43 gabeschine Exp $
 * @copyright 2003 
 * @access public
...
class AuthenticationHandler extends AuthenticationHandlerInterface {
	...
	function & authenticateAllMethods($systemName, $password) { 
		...
		$results = & new AuthenticationResult($systemName, $validList);
		return $results;
	}
